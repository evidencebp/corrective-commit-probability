...
# Standard Sql
# into tfdd.tfdd_diff_statistics
...
FROM [hotspots-readability:tfdd.tfdd_raw_statistics] 
...
FROM [hotspots-readability:tfdd.tfdd_diff_statistics] as d
join 
[hotspots-readability:tfdd.tfdd_raw_statistics] as r
on
